...
fig,ax = plt.subplots()
ax.set_title(f"All trajetories from file")
...
for i_particle in range(num_particles):
    ...
    ##ax.scatter(lons[i_particle][0], lats[i_particle][0], c='c', marker='D', s=10, zorder=10)
    ##ax.scatter(lons[i_particle][-1], lats[i_particle][-1], c='r', marker='D', s=5, zorder=11)
