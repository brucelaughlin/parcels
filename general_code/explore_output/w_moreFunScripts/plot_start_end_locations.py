...
bad_indices = [4498, 97235, 69694, 67570, 58966, 90261, 36238, 52367, 37463, 62171, 67570, 52223, 81068, 63251, 3825]
...
for dex in bad_indices:
    bad_lon_list.append(lon_all[dex,0])
    bad_lat_list.append(lat_all[dex,0])
    bad_time_list.append(time_all[dex,0])
...
#for ii in range(len(lons_end)):
#    plt.annotate(ii, xy = [lons_end[ii], lats_end[ii]], ha="center", va="center", weight="bold",c='k')

plt.scatter(lons_end, lats_end, c='r', s=1) #, zorder=3)
plt.scatter(lons_start, lats_start, c='g', s=1) #, zorder=3)

#plt.xlim(-120.64,-120.54)
#plt.ylim(34.53,34.64)
