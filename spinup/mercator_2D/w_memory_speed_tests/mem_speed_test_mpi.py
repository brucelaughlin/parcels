...
output_file_name_stem = f"mem_speed_test_01"
# -----------------
...
time_fig_name = f"time___lifetime_{particle_lifetime_days}__repeatdt___{repeatdt_days}_days___num_cs_{len(chunksize)}__{rand_number}.png"
mem_fig_name = f"mem____lifetime_{particle_lifetime_days}__repeatdt___{repeatdt_days}_days___num_cs_{len(chunksize)}__{rand_number}.png"
