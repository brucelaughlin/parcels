...
do
    ...
    jobNum=$(sbatch --parsable --export="ALL,callingDir=$callingDir,numCores=$numCores,jobFile=$jobFile,firstLineNumberBatch=$firstLineNumberBatch" $extraArgs /home/blaughli/parcels/processing/p_production/sbatch_connectivity.bash)
