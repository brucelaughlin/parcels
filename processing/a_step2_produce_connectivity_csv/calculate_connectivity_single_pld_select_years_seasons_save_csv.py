...
output_csv_dir_stem = "z_connectivity_csv_files"
#output_csv_dir_stem = "z_connectivity_csv_files_withSeasons"
output_csv_dir = os.path.join(connectivity_dir,output_csv_dir_stem)
Path(output_csv_dir).mkdir(parents=True, exist_ok=True)


file_list_all_years = sorted(script_util.find_files_os_walk(connectivity_dir, ".npz"))
